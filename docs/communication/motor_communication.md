...
机器人上比较重要的通讯代码就是电机通讯，其他传感器通讯比如相机、IMU都有官方给的程序，这里着重解析电机的通讯设计。本节解析 MOS9 使用的电机 CAN 通信驱动库 [Github: encos-driver](https://github.com/THMOS2025/encos-driver.git)，给出设计过程以及库的实现细节。
